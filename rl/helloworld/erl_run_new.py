...
from erl_agent_new import ReplayBuffer, AgentBase
...
class Evaluator:
    def __init__(self, eval_env, eval_per_step: int = 1e2, eval_times: int = 8, cwd: str = '.'):
        self.cwd = cwd
    ...
    def evaluate_and_save(self, actor, horizon_len: int, logging_tuple: tuple):
        ...
        # print(f'rewards: {rewards_steps_ary.size()}')
...
def draw_learning_curve_using_recorder(cwd: str):
    ...
    print(f"Shape of recorder: {recorder.shape}")
